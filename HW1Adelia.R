...
#Values for dice one: 3 6 5 6 2 3 4 6 6 5 3 3 6 6 2 4 2 1 4 6
...
#Values for dice two: 6 6 2 6 3 1 3 1 6 2 4 5 6 4 3 4 2 2 1 5
...
#Something interesting I learned from this data is that data can tell you not just what's happened to date,but the outcomes that your organization could produce in the future. 
